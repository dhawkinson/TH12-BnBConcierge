...
// Types related to error alerts (actions/alert.js)
export const SET_ALERT = 'SET_ALERT'
export const REMOVE_ALERT = 'REMOVE_ALERT'
// Types related to authorization/authentication (actions/auth.js)
...
// Types related to profiles (actions/favorite.js)
